...
<section class="header">
    <header class="aui-bar aui-bar-nav" id="aui-header">
        <font style="float: left;margin-left: 10px;">FREEKAN</font>
    ...
    <div class="nav-wrap">
        ...
        <div class="wrap">
            <ul>
                ...
                <li class=""><a href="{{$v['navaddr']}}">{{$v['navname']}}</a></li>
                    @endforeach
                @else
                @endif
                <li>{!! config('appconfig.isdh')?'<a href="/app.html" target="_blank">'.config('appconfig.appdh').'</a>':'' !!}</li>
            </ul>
        </div>
    </div>
</section>
...
<script type="text/javascript" src="/public/static/joeleo/js/home.js"></script>
<script type="text/javascript" src="/public/static/joeleo/js/aui-scroll.js"></script>
...
<div id="search" class="search">
    ...
    <div id="_js_goTop" class="gotop" style="display: none;">

        ...
        <section class="container">
            <div class="content-wrap">
                <div class="content">
                    ...
                    <div class="sptitle"><h1>正在播放--{{$cxs['dyname']}}<span class="js"></span></h1></div>
                    <div id="bof">
                    </div>
                    <div class="am-cf"></div>
                                    ...
                                    <div class="top-list-ji">
                                        ...
                                        <div class="ji-tab-content js-tab-content" style="opacity:1;">
                                            @foreach($cxs['dyaddr'] as $v)
                                                <a data-href='{{$v['url']}}' href="javascript:void (0)" id="bofang" class="am-btn am-btn-default lipbtn" onclick="bofang(this)" target='ajax'>{{$v['name']}}</a>
                                            @endforeach
                                        </div>
                                    </div>
                                </div>

                        ...
                        <ul class="clearfix">
                            @foreach($zys as $zy)
                                <div class="col-md-2 col-sm-3 col-xs-4">
                                    <a class="videopic lazy" href="/play/{{$zy['url']}}.html" title="{{$zy['title']}}" src="{{$zy['img']}}" onclick="jilu(this)" style="background: url({{$zy['img']}}) no-repeat; background-position:50% 50%; background-size: cover;"><span class="play hidden-xs"></span><span class="score">{{$zy['js']}}</span></a>
                                    <div class="title">

                        ...
                        <div class="am-panel-bd">
                            ...
                            <div class="video-list view-font">
                                <div class="dianshijua" id="dianshijuid">
                                    <h3 class="single-strong">{{$zd}}<font color="#ff6651"></font></h3>
                                    <div class="top-list-ji">
                                        ...
                                        <div class="ji-tab-content js-tab-content" style="opacity:1;">
                                            @foreach($zylist as $v)
                                                <a  data-href='{{isset($v['href'])?$v['href']:'#'}}' href="javascript:void (0)"  class="am-btn am-btn-default lipbtn" onclick="bofang(this)" target='ajax'>{{isset($v['href'])?$v['time']:'暂无可用播放源'}}</a>
                                            @endforeach
                                        </div>
                                    </div>
                                </div>
